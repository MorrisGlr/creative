...
const webpGlobs = {
  photos:    import.meta.glob('../content/photos/*/media/*.webp',    { eager: true, query: '?url', import: 'default' }),
  textbooks: import.meta.glob('../content/textbooks/*/media/*.webp', { eager: true, query: '?url', import: 'default' }),
  algo:      import.meta.glob('../content/algo/*/media/*.webp',      { eager: true, query: '?url', import: 'default' }),
  paper:     import.meta.glob('../content/paper/*/media/*.webp',     { eager: true, query: '?url', import: 'default' }),
};
